...
public class BioJavaBlastService {
	...
	private static final String BLAST_OUTPUT_FILE = "blastOutput2.xml";    // file to save blast results to
	private static final String SEQUENCE = "TSDDRGIVYSKSLD";     // Blast query sequence
	...
	public static void main(String[] args) {
		...
		props.setAlignmentOption(BlastAlignmentParameterEnum.HITLIST_SIZE, "100");
