...
public class Model implements Presenter.Model {
	...
	public ArrayList<UniProtHit> fetchBlastHits(String proteinAcc, DatabaseOption databaseOption,
		...
		// TODO Auto-generated method stub
		UniprotBlastService ubs = new UniprotBlastService(new Protein(proteinAcc, true), databaseOption,
				expectationOption, filterOption, dropOffOption, matrixOption, scoreCutoffOption, isGapAlign, gapExt,
